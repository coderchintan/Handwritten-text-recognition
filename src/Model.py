...
class Model: 
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open('/home/chintan/Projects/hello/SimpleHTR-master/model/wordCharList.txt').read().splitlines()[0]
			corpus = open('/home/chintan/Projects/hello/SimpleHTR-master/data/corpus.txt').read()
	...
	def setupTF(self):
		...
		modelDir = '/home/chintan/Projects/hello/SimpleHTR-master/model/model/'
